...
use Carbon\Carbon;
use ikepu_tp\DesignerHelper\database\factories\Func_classFactory;
 ...
 */
class Func_class extends BaseModel
{
    /**
    ...
    protected static $factoryModel = Func_classFactory::class;
